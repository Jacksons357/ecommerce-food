...
const activeItemStyles = 'bg-slate-700 text-neutral-100';
                ...
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <div className="lg:hidden">
                        <Sheet>
                            ...
                            <SheetContent side="left" className="flex h-full w-64 flex-col items-stretch justify-between bg-slate-800">
                                <SheetTitle className="sr-only">Navigation Menu</SheetTitle>
                                <SheetHeader className="flex justify-start text-left">
                                    <AppLogoIcon className="h-6 w-6 fill-current text-neutral-100" />
                                </SheetHeader>
                            ...
                            <NavigationMenuList className="flex h-full items-stretch space-x-2">
                                {mainNavItems.map((item, index) => (
                                    <NavigationMenuItem key={index} className="relative flex h-full items-center">
                                        ...
                                        {page.url === item.href && (
                                            <div className="absolute bottom-0 left-0 h-0.5 w-full translate-y-px bg-red-700"></div>
                                        )}
                                    </NavigationMenuItem>
                                ))}
                            </NavigationMenuList>
                            ...
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" className="size-10 rounded-full p-1">
                                    <Avatar className="size-8 overflow-hidden rounded-full">
                                        ...
                                        <AvatarFallback className="rounded-lg bg-slate-700 text-neutral-100">
