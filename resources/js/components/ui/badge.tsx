...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive transition-[color,box-shadow] overflow-auto",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-red-700 text-neutral-100 [a&]:hover:bg-red-800",
        secondary:
          "border-transparent bg-slate-700 text-neutral-100 [a&]:hover:bg-slate-600",
        destructive:
          "border-transparent bg-red-600 text-white [a&]:hover:bg-red-700 focus-visible:ring-red-500/20",
        outline:
          "text-neutral-100 border-slate-600 [a&]:hover:bg-slate-700 [a&]:hover:text-neutral-100",
      },
    },
    defaultVariants: {
      variant: "default",
