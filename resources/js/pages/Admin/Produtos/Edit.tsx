                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <Input
                                            ...
                                            className="text-neutral-100"
                                        />
                                        <p className="text-sm text-gray-500">Cole aqui a URL da imagem do produto</p>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center space-x-2">
                                        <Checkbox
                                            ...
                                            onCheckedChange={(checked) => setFormData((prev) => ({ ...prev, destaque_dia: checked as boolean }))}
                                        />
                                ...
                                <div className="flex space-x-4 pt-4">
                                    <Button type="button" variant="outline" onClick={() => router.visit('/admin/produtos')} className="flex-1">
                                        Cancelar
                                    </Button>
