                  ...
                  >
                    <Card className="overflow-hidden border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-white shadow-xl">
                      <CardHeader className="bg-gradient-to-r from-orange-100 to-red-100 border-b border-orange-200">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              <CardTitle className="text-lg text-orange-800">Pedido #{pedido.id}</CardTitle>
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="mb-6">
                          ...
                          <div className="space-y-3">
                            {pedido.items.map((item) => (
                              <div key={item.id} className="flex items-center justify-between p-3 bg-white rounded-lg border-2 border-orange-200 shadow-md hover:shadow-lg transition-all duration-300">
                                <div className="flex items-center space-x-3">
                                  ...
                                  />
                                  <div>
                                    <p className="font-medium text-orange-800">{item.produto.nome}</p>
                                    <p className="text-sm text-orange-600">
                        ...
                        {pedido.observacoes && (
                          <div className="mb-6">
                            <h4 className="font-semibold text-orange-800 mb-2">Observações</h4>
                            <p className="text-orange-600 bg-white p-3 rounded-lg border-2 border-orange-200">
                              {pedido.observacoes}
                            </p>
                          </div>
                        )}
                ...
                >
                  <Card className="text-center py-12 border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-white shadow-xl">
                    <CardContent>
                      ...
                      <h3 className="text-xl font-semibold text-orange-800 mb-2">Nenhum pedido encontrado</h3>
