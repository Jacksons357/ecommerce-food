...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-neutral-900 p-6 text-neutral-100 lg:justify-center lg:p-8">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                href={route('dashboard')}
                                className="inline-block rounded-sm border border-slate-700 px-5 py-1.5 text-sm leading-normal text-neutral-100 hover:border-slate-600"
                            >
                                Dashboard
                            </Link>
                        ) : (
                            <>
                                <Link
                                    href={route('login')}
                                    className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-neutral-100 hover:border-slate-700"
                                >
                                    Entrar
                                </Link>
                                <Link
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg border border-slate-700 bg-slate-800 p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20">
                            <h1 className="mb-1 font-medium text-neutral-100">Vamos começar</h1>
                            <p className="mb-2 text-neutral-400">
                                Laravel tem um ecossistema incrivelmente rico.
                                <br />
                                Sugerimos começar com o seguinte.
                            </p>
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-slate-700">
                                    <span className="relative bg-slate-800 py-1">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-slate-700 bg-slate-800 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]">
                                    ...
                                    <span className="text-neutral-100">
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-red-700 underline underline-offset-4"
                                        >
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-slate-700">
                                    <span className="relative bg-slate-800 py-1">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-slate-700 bg-slate-800 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-slate-600" />
                                        </span>
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-slate-700 bg-red-700 px-5 py-1.5 text-sm leading-normal text-neutral-100 hover:border-slate-600 hover:bg-red-800"
                                    >
                                        Fazer deploy agora
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg border border-slate-700 bg-slate-800 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg">
                            <svg
                                className="w-full max-w-none translate-y-0 text-red-700 opacity-100 transition-all duration-750 starting:translate-y-6 starting:opacity-0"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
